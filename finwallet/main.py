...
st.set_page_config(page_title="XL access",page_icon="📊")
...
st.sidebar.title("XL access")

col1, col2, col3 = st.columns(3)
with col1:
    st.write(' ')
with col2:
    image = Image.open("finwallet/inwallet.png")
    st.image(image)
with col3:
    st.write(' ')
...
if file_name is not None:
    ...
    if sheet_selector=="PINCODE":
       ...
       if selected_Pin or selected_Ban:
        ...
        csv = convert_df(df6.reset_index(drop = True))
